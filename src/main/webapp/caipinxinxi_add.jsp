...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="caipinbianhao" name="caipinbianhao" value="${Info.getID()}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" data-rule-required="true" data-msg-required="请填写菜品名称" id="caipinmingcheng" name="caipinmingcheng" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
...
<option value="${m.id}">${m.fenleimingcheng}</option>
    ...
    <input type="text" class="form-control" data-rule-required="true" data-msg-required="请填写菜品图片" id="caipintupian" name="caipintupian" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写折扣价" number="true" data-msg-number="输入一个有效数字" id="zhekoujia" name="zhekoujia" value=""/>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写库存" number="true" data-msg-number="输入一个有效数字" id="kucun" name="kucun" value="0"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea id="caipinxiangqing" name="caipinxiangqing" style="max-width: 750px;width:100%; height: 300px;"></textarea><script>
            (function(){
