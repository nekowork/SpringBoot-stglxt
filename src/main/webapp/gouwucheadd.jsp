...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <ssm:sql var="mapcaipinfenlei12" type="find">SELECT fenleimingcheng FROM caipinfenlei where id='${readMap.fenlei}'</ssm:sql>${mapcaipinfenlei12.fenleimingcheng}<input type="hidden" id="fenlei" name="fenlei" value="${Info.html(readMap.fenlei)}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
