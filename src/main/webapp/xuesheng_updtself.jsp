        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="xueshengupdate.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" style="width:150px;" data-rule-required="true"
                                       ...
                                       data-msg-remote="内容重复了" id="xuehao" name="xuehao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="form-control class_xingbie3" data-value="${Info.html(mmm.xingbie)}"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">身份证<span
                                    style="color: red;">*</span></label>
                            <div class="col-sm-8">

                                <input type="text" class="form-control" style="width:150px;" data-rule-required="true"
                                       data-msg-required="请填写身份证"
                                       remote="checkno.do?checktype=update&id=${mmm.id}&table=xuesheng&col=shenfenzheng"
                                       data-msg-remote="内容重复了" idcard="true" data-msg-email="请输入有效身份证号码"
                                       id="shenfenzheng" name="shenfenzheng" value="${Info.html(mmm.shenfenzheng)}"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
