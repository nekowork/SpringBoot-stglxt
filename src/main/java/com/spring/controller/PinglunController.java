...
public class PinglunController extends BaseController {
    ...
    public String insert() {
        ...
        post.setQitaid(Request.getInt("qitaid"));
    ...
    /*    Query.execute("update caipinxinxi set pingfen=(SELECT AVG(pingfen) FROM pingfen WHERE id ='" + request.getParameter("biaoid") + "') where id='" + request.getParameter("biaoid") + "'");
*/

        Query.execute("update caipinxinxi set pingfen=(SELECT AVG(pingfen) FROM pinglun WHERE biaoid='"+request.getParameter("biaoid")+"') where id='"+request.getParameter("biaoid")+"'");
    ...
    public String detail() {
        ...
        return "pinglun_detail";  // 详情页面：WebRoot\pinglun_detail.jsp
    }
